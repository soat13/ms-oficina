...
func TestCreateUser(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		resp := postCreateUser(t, payload)
		require.Equal(t, fiber.StatusCreated, resp.StatusCode)

		assertUserCreated(t, payload)
	})
	...
	t.Run("DuplicateEmail", func(t *testing.T) {
		...
		_ = testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Existing User", "11144477735", "11987654321", "existing@example.com", "password123", []string{"attendant"})
...
func TestGetUser(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		uid := testsupport.ThereIsAUser(t, env.db, uuid.Nil, "John Mechanic", "85891302071", "11987654321", "user@example.com", "password123", []string{"mechanic"})
		resp := getUser(t, uid)
...
func TestUpdateUser(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		uid := testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Old Name", "85891302071", "11987654321", "olduser@example.com", "oldpassword", []string{"mechanic"})

		newName := "New Name"
		newEmail := "newemail@example.com"
		newPhone := "11999999999"
		resp := updateUser(t, uid, updateBody{
			Name:        &newName,
			Email:       &newEmail,
	...
	t.Run("ChangePassword", func(t *testing.T) {
		...
		uid := testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Password Test", "52998224725", "11987654321", "pwdtest@example.com", "oldpassword", []string{"attendant"})
	...
	t.Run("NotFound", func(t *testing.T) {
		...
		newName := "New Name"
		resp := updateUser(t, uuid.New(), updateBody{
			Name: &newName,
		})
		require.Equal(t, fiber.StatusNotFound, resp.StatusCode)
	})
	...
	t.Run("UpdateRoles", func(t *testing.T) {
		...
		uid := testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Role Test", "11144477735", "11987654321", "roletest@example.com", "password123", []string{"attendant"})
	...
	t.Run("UpdateRolesEmptyList", func(t *testing.T) {
		...
		uid := testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Test User", "52998224725", "11987654321", "emptytest@example.com", "password123", []string{"attendant"})
	...
	t.Run("UpdateRolesInvalid", func(t *testing.T) {
		...
		uid := testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Invalid Test", "02383727075", "11987654321", "invalidtest@example.com", "password123", []string{"attendant"})
...
func TestDeleteUser(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		uid := testsupport.ThereIsAUser(t, env.db, uuid.Nil, "To Delete", "02383727075", "11987654321", "todelete@example.com", "password123", []string{"attendant"})
		resp := deleteUser(t, uid)
		require.Equal(t, fiber.StatusNoContent, resp.StatusCode)
...
func TestListUsers(t *testing.T) {
	t.Run("OrderByName", func(t *testing.T) {
		...
		bob, alice := givenUsers(t)

		resp := listUsers(t, 10, 0)
		require.Equal(t, fiber.StatusOK, resp.StatusCode)
...
func givenUsers(t *testing.T) (bob, alice uuid.UUID) {
	t.Helper()
	bob = testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Bob Manager", "11144477735", "11987654321", "bob@example.com", "password123", []string{"manager"})
	alice = testsupport.ThereIsAUser(t, env.db, uuid.Nil, "Alice Mechanic", "98765432100", "11987654322", "alice@example.com", "password123", []string{"mechanic"})
	return bob, alice
}

func assertUserCreated(t *testing.T, payload createBody) {
	t.Helper()
...
func postCreateUser(t *testing.T, body createBody) *http.Response {
	t.Helper()
...
func getUser(t *testing.T, id uuid.UUID) *http.Response {
	t.Helper()
...
func updateUser(t *testing.T, id uuid.UUID, body updateBody) *http.Response {
	t.Helper()
...
func deleteUser(t *testing.T, id uuid.UUID) *http.Response {
	t.Helper()
...
func listUsers(t *testing.T, limit, offset int) *http.Response {
	t.Helper()
