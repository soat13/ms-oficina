...
func (r *BunRepairOrderRepository) SaveIfPaymentRequested(ctx context.Context, ro *domain.RepairOrder) error {
	return r.saveIfStatus(ctx, ro, repairorder.StatusPaymentRequested)
}
