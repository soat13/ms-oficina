...
import (
	...
	"github.com/soat13/ms-oficina/internal/customer/application"
	"github.com/soat13/ms-oficina/internal/customer/infra/in/http"
	"github.com/soat13/ms-oficina/internal/customer/infra/out/db"
)
